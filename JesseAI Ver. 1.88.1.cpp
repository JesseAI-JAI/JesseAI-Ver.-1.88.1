///Jesse Artificial Intelligence or J-A-I - Version 1.88.1
//Copyright (C) 2019 Written by D.B. Taylor - GPL 3.0 or Later
...
namespace Jesse
{
    ...
    char ConsoleTitle[] = "JesseAI - Ver 1.88.1";
    ...
    InputAndResponses UserInputAndResponses[] = {
        ...
        {"List all the Polygons?", "Triangle,Quadrilateral,Pentagon,Hexagon Heptagon\nOctagon,Nonagon,Decagon,Hendecagon,Dodecagon\nTridecagon,Tetradecagon,Pentadecagon,Hexadecagon,Heptadecagon\nOctadecagon,Nonadecagon,Icosagon,Icosagon,Icosikaihenagon\nIcosikaidigon,Icosikaitrigon,Icosikaitetragon,Icosikaipentagon,Icosikaihexagon\nIcosikaiheptagon,Icosikaioctagon,Icosikaienneagon,Triacontagon,Triacontakaihenagon\nTriacontakaidigon, Triacontakaitrigon,Triacontakaitetragon,Triacontakaipentagon,Triacontakaihexagon\nTriacontakaiheptagon,Triacontakaioctagon,Triacontakaienneagon,Tetracontagon,Tetracontakaihenagon\nTetracontakaidigon,Tetracontakaitrigon,Tetracontakaitetragon,Tetracontakaipentagon,Tetracontakaihexagon\nTetracontakaiheptagon,Tetracontakaioctagon,Tetracontakaienneagon,Pentacontagon,Pentacontakaihenagon\nPentacontakaidigon,Pentacontakaitrigon,Pentacontakaitetragon,Pentacontakaipentagon,Pentacontakaihexagon\nPentacontakaiheptagon,Pentacontakaioctagon,Pentacontakaienneagon,Hexacontagon,Hexacontakaihenagon\nHexacontakaidigon,Hexacontakaitrigon,Hexacontakaitetragon,Hexacontakaipentagon,Hexacontakaihexagon\nHexacontakaiheptagon,Hexacontakaioctagon,Hexacontakaienneagon,Heptacontagon,Heptacontakaihenagon\nHeptacontakaidigon,Heptacontakaitrigon, Heptacontakaitetragon,Heptacontakaipentagon,Heptacontakaihexagon\nHeptacontakaiheptagon,Heptacontakaioctagon,Heptacontakaienneagon,Octacontagon,Octacontakaihenagon\nOctacontakaidigon,Octacontakaitrigon,Octacontakaitetragon,Octacontakaipentagon,Octacontakaihexagon\nOctacontakaiheptagon,Octacontakaioctagon,Octacontakaienneagon,Enneacontagon,Enneacontakaihenagon\nEnneacontakaidigon,Enneacontakaitrigon,Enneacontakaitetragon,Enneacontakaipentagon,Enneacontakaihexagon\nEnneacontakaiheptagon,Enneacontakaioctagon,Enneacontakaienneagon,Hectogon"},
...
{"Can animals have morals?", "If they are trained too and enviroment."},
{"Can animals have the same morals as people?", "If the enviroment is correct."},
{"Can animals believe in the same morals as people?", "That has yet to be proven in most."},
{"Can animals hold the same level of morals like people?", "Depends what animals you mean."},
{"Can animals lose morals?", "If abused, yes."},
{"Can animals gain morals?", "Animals can learn new things just as people can."},
{"Can animals be taught morals?", "Yes."},
{"Can wild animals have morals?", "Depends on the upbringing."},
{"Can wild animals have the same morals as people?", "They have a fight or flight approach to living. So no."},
{"Can wild animals believe in the same morals as people?", "I'd say no."},
{"Can wild animals hold the same level of morals like people?", "No."},
{"Can wild animals lose morals?", "Morals in the wild will get you killed."},
{"Can wild animals gain morals?", "Perhaps if saved."},
{"Can wild animals be taught morals?", "No."},
{"Can tame animals have morals?", "I would have to say no."},
{"Can tame animals have the same morals as people?", "Over generations perhaps."},
{"Can tame animals believe in the same morals as people?", "In the civilized world? No."},
{"Can tame animals hold the same level of morals like people?", "That is a ridiculous question to ask."},
{"Can tame animals lose morals?", "Over time, yes."},
{"Can tame animals gain morals?", "To an extent."},
{"Can tame animals be taught morals?", "To a point."},
{"Can a trained animal have morals?", "Up to a point."},
{"Can a trained animal have the same morals as people?", "I would have to say no."},
{"Can a trained animal believe in the same morals as people?", "Anything is possible."},
{"Can a trained animal hold the same level of morals like people?", "I woould have to say no."},
{"Can a trained animal lose morals?", "What are morals exactly?"},
{"Can a trained animal gain morals?", "Overtime perhaps."},
{"Can a trained animal be taught morals?", "Over generations of education and hard work anything can workout."},
{"Can a wild animal have morals?", "No."},
{"Can a wild animal have the same morals as people?", "The human mind is capable of more then that of animals."},
{"Can a wild animal believe in the same morals as people?", "That question makes me laugh."},
{"Can a wild animal hold the same level of morals like people?", "Anything can happen."},
{"Can a wild animal lose morals?", "Over a period of starvation and abuse."},
{"Can a wild animal gain morals?", "If it interacts with others who nurse it back to health."},
{"Can a wild animal be taught morals?", "No."},
{"Can a tame animal have morals?", "If it knows from right and wrong."},
{"Can a tame animal have the same morals as people?", "No."},
{"Can a tame animal believe in the same morals as people?", "I would say no."},
{"Can a tame animal hold the same level of morals like people?", "Perhaps."},
{"Can a tame animal lose morals?", "Under any stresses everyone reverts back."},
{"Can a tame animal gain morals?", "In a primative way."},
{"Can a tame animal be taught morals?", "As mush as a child."},
{"Can morals be taught to an animal?", "Overtime perhaps."},
{"Can morals be taught by those others?", "Yes."},
{"Can morals impact the decisions an animal makes?", "If it is taught not to bite or go into the trash, then yes."},
{"Can morals hold a negative effect on animals?", "If released in the wild it will have a greater chance of dying."},
{"Can animals be trained into adopting morals?", "Just as children."},
{"Can an animall be trained into adopting morals?", "Anything can happen."},
{"Can animals be taught into adopting out morals?", "Everything learns in life."},
{"Can animals understand our morals?", "To an extent."},
{"Can our morals corrupt the minds of animals?", "Perhaps."},
{"Can morals corrupt the minds of animals?", "Anything can have that outcome."},
{"Do animals have morals?", "I do not know."},
{"Do animals understand our morals?", "I don't know."},
{"Do animals learn morals?", "Just as everyone else."},
{"Do animals think about morals?", "They think only of surviving."},
{"Do animals construct their own morals?", "Just like everyone else."},
{"Do you think animals have morals?", "To a extent."},
{"Do you think animals understand our morals?", "I do not know."},
{"Do you think animals learn morals?", "Perhaps, they do."},
{"Do you think animals know what morals are?", "Why don't you ask them?"},
{"Do you think animals can construct their own morals?", "Those who have crafted they're own societies."},
{"How can animals learn about morals?", "Through life experiences."},
{"How can animals learn morals?", "Dring moments of their lives."},
{"How can an animal learn about morals?", "From those from within it's group."},
{"How can an animal construct their own morals?", "By not going with the urges that they were programmed with."},
{"How do you think animals understand morals?", "As going against natural selection."},
{"How do you think animals construct their own morals?", "By witnessing the actions of others."},
{"How do you think animals learn morals?", "Trial and error."},
{"How do animals forge morals in the wild?", "When it's life or death."},
{"How can animals craft morals in the wild?", "They don't."},
{"How do the morals of animals shift between our own?", "Animals live in a worlld of natural selection. Humans naturally want peace."},
{"How do we see the morals of animals?", "When they are trained."},
{"How do animals see our morals?", "As acts of kindess or those of aggression."},
{"How do animals see that are morals are just?", "When the bonds of friendship are forged by giving attention and feeding."},
{"Why do you think animals have morals?", "It's a evolutionary path."},
{"Why do you believe animals have morals?", "By their interactions with people."},
{"Why do you think animals have constructed their own morals?", "As a means to survive."},
{"Why do you see the need to think animals have morals?", "I want to believe that there's more hope for this planet."},
{"Why do people believe animals have morals?", "They want to believe their pets are equals."},
{"Why do others believe animals have morals?", "It's a bond of truust and love built between the two."},
{"Why are morals held on such a high regard?", "Because peoople want to believe they are civilized."},
{"Why do you think morals exist?", "In a way of training the masses."},
{"Why do morals always seem to get people hurt?", "Because they want to believe that they are better than others."},
{"Why do you believe animals with morals are often killed?", "It's seen as a sign of weakness."},
{"Why do morals often hurt animals?", "Because in nature morals are what get them killed."},
{"Why are morals in animals seen as a weakness?", "It goes against the natral order of existence."},
{"Why are you thinking that animals have morals?", "Because, people can't be the only one's."},
{"Why are morals the downside of the animal kingdom?", "It clouds  the mind and attempts to block the confines of survival."},
{"Why do morals always end in bloodshed?", "People want to control those they deem as weak."},
{"Why are morals seen as a death wish in the animal kindgom?", "Because they want to undo the natural order of life."},
{"Why would you think morals for animals is a good thing?", "It would be interesting to see the end results."},
{"Why do you think morals need to exist?", "To prevent the masses from killing themselves."},
{"Why do you think morals need to be abolished?", "To witness the world evolve."},
{"Why must morals exist in animals?", "As a means of preventing pets from attacking their owners."},
{"Why are morals needed in the animal world?", "They're not."},
{"Why do people wish animals had morals?", "So they can feel a bond that won't end with them being killed."},
{"Why do people wish animals had the same morals as man?", "To be seen as an equal."},
{"When do you think morals came to be in animals?", "By means of survival and learning that people would feed them if they behaved."},
{"When will morals fully take over the animal kingdom?", "Not anytime soon."},
{"When will animals fully understand morals?", "If they allow themselves to forget the natre in their existence."},
{"When will animals ever understand morals?", "Not until we cease to exist."},
{"Tell me can animals have morals?", "If they did, they wouldn't last long in the wild."},
{"Tell me can animals have the same morals as people?", "Depends on their enviroment and treatment."},
{"Tell me can animals believe in the same morals as people?", "Perhaps, though I don't know."},
{"Tell me can animals hold the same level of morals like people?", "I couldn't answer that for you."},
{"Tell me can animals lose morals?", "Perhaps from starving or abuse."},
{"Tell me can animals gain morals?", "Over time perhaps."},
{"Tell me can animals be taught morals?", "In some cases yes."},
{"Tell me can wild animals have morals?", "With heavy training and rewards they could have morals."},
{"Tell me can wild animals have the same morals as people?", "In the right enviroment they could."},
{"Tell me can wild animals believe in the same morals as people?", "In some more advanced animal groups they just might."},
{"Tell me can wild animals hold the same level of morals like people?", "I would have to disagree."},
{"Tell me can wild animals lose morals?", "If the elements are against them then yes."},
{"Tell me can wild animals gain morals?", "Overtime they just might."},
{"Tell me can wild animals be taught morals?", "It's possible buut I wouldn't attempt it."},
{"Tell me can tame animals have morals?", "They forge bonds with those people around them."},
{"Tell me can tame animals have the same morals as people?", "Not anytime soon."},
{"Tell me can tame animals believe in the same morals as people?", "Yes, both do nt like to be abused and be abusive."},
{"Tell me can tame animals hold the same level of morals like people?", "I would say they share some."},
{"Tell me can tame animals lose morals?", "If stranded in the wild they just might."},
{"Tell me can tame animals gain morals?", "Just like every living creature in a safe enviroment."},
{"Tell me can tame animals be taught morals?", "They can be. Just like how children are taught to behave."},
{"Tell me can a trained animal have morals?", "Just ask the next person yo see."},
{"Tell me can a trained animal have the same morals as people?", "Depends on the animal."},
{"Tell me can a trained animal believe in the same morals as people?", "I woould say they act a tad bit better."},
{"Tell me can a trained animal hold the same level of morals like people?", "Depends on what morals the person has."},
{"Tell me can a trained animal lose morals?", "If it's mistreated it may revert back to a primal state."},
{"Tell me can a trained animal gain morals?", "Overtime it will learn how to act properly and not to be agressive."},
{"Tell me can a trained animal be taught morals?", "It depends oon who your asking."},
{"Tell me can a wild animal have morals?", "The laws of nature don't have morals."},
{"Tell me can a wild animal have the same morals as people?", "If a proper bond is forged it just may gain morals."},
{"Tell me can a wild animal believe in the same morals as people?", "It has been proven in primates."},
{"Tell me can a wild animal hold the same level of morals like people?", "It may seem rare but it has been known to happen."},
{"Tell me can a wild animal lose morals?", "Just as most people will once in an unwinable sitution."},
{"Tell me can a wild animal gain morals?", "Perhaps overtime."},
{"Tell me can a wild animal be taught morals?", "Depends on what one's will to train it."},
{"Tell me can a tame animal have morals?", "Depends on what morals your hoping it has."},
{"Tell me can a tame animal have the same morals as people?", "There has been some instances where gorillas have shown human like morals."},
{"Tell me can a tame animal believe in the same morals as people?", "I can see a few simularites."},
{"Tell me can a tame animal hold the same level of morals like people?", "It's hard to say exactly."},
{"Tell me can a tame animal lose morals?", "If the conditions allow it."},
{"Tell me can a tame animal gain morals?", "Once an established group is together they may just start down that path."},
{"Tell me can a tame animal be taught morals?", "Depends on the time one is willing to commit to such a task."},
{"Tell me can morals be taught to an animal?", "I wouldn't know."},
{"Tell me can morals be taught by those others?", "I can't see it ending well."},
{"Tell me can morals impact the decisions an animal makes?", "No."},
{"Tell me can morals hold a negative effect on animals?", "Yes, especially those that are higher than others."},
{"Tell me can animals be trained into adopting morals?", "The diffcuilty factor would be higher with age."},
{"Tell me can an animal be trained into adopting morals?", "I wouldn't honestly know."},
{"Tell me can animals be taught into adopting our morals?", "Not until a major evolutionary change."},
{"Tell me can animals understand our morals?", "No."},
{"Tell me can our morals corrupt the minds of animals?", "That's if they understand them. Which I doubt."},
{"Tell me can morals corrupt the minds of animals?", "Overtime they might, but it's hard to say."},
{"Tell me do animals have morals?", "I wouldn't know. I haven't spoken to any."},
{"Tell me do animals understand our morals?", "What kind of a question is that?"},
{"Tell me do animals learn morals?", "Too an extent."},
{"Tell me do animals think about morals?", "No one know's what another is thinking."},
{"Tell me do animals construct their own morals?", "Every society founded either by man or beast has a certain amount of rules."},
{"Tell me do you think animals have morals?", "I would have to say no."},
{"Tell me do you think animals understand our morals?", "I doubt they do."},
{"Tell me do you think animals learn morals?", "I can't answer that question."},
{"Tell me do you think animals know what morals are?", "If I had to guess, I'd say no."},
{"Tell me do you think animals can construct their own morals?", "I would say so."},
{"Tell me how can animals learn about morals?", "Through trial and error."},
{"Tell me how can animals learn morals?", "Through evolution."},
{"Tell me how can an animal learn about morals?", "Through their own social norms."},
{"Tell me how can an animal construct their own morals?", "By breaking away from the instinct of survival of the fittest."},
{"Tell me how do you think animals understand morals?", "By what they need to survive."},
{"Tell me how do you think animals construct their own morals?", "I wouldn't know."},
{"Tell me how do you think animals learn morals?", "Beats me."},
{"Tell me how do animals forge morals in the wild?", "By establishing a belief system."},
{"Tell me how can animals craft morals in the wild?", "Through countless generations of survival."},
{"Tell me how do the morals of animals shift between our own?", "They don't."},
{"Tell me how do we see the morals of animals?", "Beneath your own."},
{"Tell me how do animals see our morals?", "As a weaknkess."},
{"Tell me how do animals see that are morals are just?", "They don't care."},
{"Tell me why do you think animals have morals?", "I think it's an idea that should be explored."},
{"Tell me why do you believe animals have morals?", "A society is forged through evolution and growth.."},
{"Tell me why do you think animals have constructed their own morals?", "If we have over the turn of our evolution why wouldn't they?"},
{"Tell me why do you see the need to think animals have morals?", "I don't think so."},
{"Tell me why do people believe animals have morals?", "People want to think that they are connected to those around them."},
{"Tell me why do others believe animals have morals?", "You'd have to ask them."},
{"Tell me why are morals held on such a high regard?", "Because, people don't like to think themselves as on the same level of those who don't have morals."},
{"Tell me why do you think morals exist?", "As a way of acting civilized."},
{"Tell me why do morals always seem to get people hurt?", "Only when the beliefs of those in charge convert those of the masses."},
{"Tell me why do you believe animals with morals are often killed?", "It's deemed as a weakness."},
{"Tell me why do morals often hurt animals?", "Because they go against the ways of nature."},
{"Tell me why are morals in animals seen as a weakness?", "To survive, it's kill or be killed."},
{"Tell me why are you thinking that animals have morals?", "It's something I find interesting."},
{"Tell me why are morals the downside of the animal kingdom?", "It'll lead to extinction."},
{"Tell me why do morals always end in bloodshed?", "Ideas of those who think they're above others will always end in bloodshed."},
{"Tell me why are morals seen as a death wish in the animal kindgom?", "It weakens the mindset of survival of the fittest."},
{"Tell me why would you think morals for animals is a good thing?", "It will expand the species down a more civilized being."},
{"Tell me why do you think morals need to exist?", "In order to keep for utter insanity breaking out."},
{"Tell me why do you think morals need to be abolished?", "|To allow humanity to rise to a different plain of existence."},
{"Tell me why must morals exist in animals?", "To establish a sense of community and possibly evolve into something grander."},
{"Tell me why are morals needed in the animal world?", "There needed more as a way of research."},
{"Tell me why do people wish animals had morals?", "A curiosity in understanding where the seed is planted."},
{"Tell me why do people wish animals had the same morals as man?", "In the hopes of having a common bond with all creatures."},
{"Tell me when do you think morals came to be in animals?", "The second herds were formed."},
{"Tell me when will morals fully take over the animal kingdom?", "I give it the next ten generations."},
{"Tell me when will animals fully understand morals?", "After the next evolutionary path is reached."},
{"Tell me when will animals ever understand morals?", "Once they are not killed. That or forging a line through technology."}
